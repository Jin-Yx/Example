...
class MqttConnection implements MqttCallbackExtended {
	 ...
	 * 
	 * @param service
	 *            our "parent" org.eclipse.paho.android.service - we make callbacks to it
	 * @param serverURI
	 ...
	 * @param qos
	 *            the quality of org.eclipse.paho.android.service requested
	 * @param retained
	 ...
	 * @param qos
	 *            requested quality of org.eclipse.paho.android.service for the topic
	 * @param invocationContext
	 *            arbitrary data to be passed back to the application
	 * @param activityToken
	 *            arbitrary identifier to be passed back to the Activity
	 ...
	 * @param qos
	 *            requested quality of org.eclipse.paho.android.service for each topic
	 * @param invocationContext
	 *            arbitrary data to be passed back to the application
	 * @param activityToken
	 *            arbitrary identifier to be passed back to the Activity
